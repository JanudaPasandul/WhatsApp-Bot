...
async function sewQueen () {
    ...
    setInterval(async () => { 
        ...
        while (getGMTh == 19 && getGMTm == 1) {
            ...
            if (Raviya.LANG == 'SI') ilan = '| *✨Neo Pilot වට්සැප් බොට් සදහා දෛනික නිවේදන✨* |\n\n'
...
${chalk.blue.italic('📲 Try To Login WhatsApp... Please Wait...')}`);
    ...
    CdSew.on('credentials-updated', async () => {
        ...
        console.log(chalk.bgGreen('Neo Pilot is' + rssewqueengg));
                        ...
                        try {
                            ...
                            if (Raviya.LANG == 'SI') {
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*‍️ දෝෂ විශ්ලේෂණය [Neo Pilot] ‍️*' +
                                        '\n========== ```දෝෂ නිරාකරණය කර ඇත!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*‍️ ERROR ANALYSIS [Neo Pilot] ‍️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
